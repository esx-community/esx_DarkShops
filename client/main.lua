...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('esx_dark:requestDBItems', function(ShopItems)
...
Citizen.CreateThread(function()
	while true do
		...
		if isInMarker and not HasAlreadyEnteredMarker then
			...
			TriggerEvent('esx_dark:hasEnteredMarker', currentZone)
		end
		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('esx_dark:hasExitedMarker', LastZone)
		end
	end
end)
